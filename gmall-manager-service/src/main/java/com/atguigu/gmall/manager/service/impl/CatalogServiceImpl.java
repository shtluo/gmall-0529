...
public class CatalogServiceImpl implements CatalogService {
    ...
    public List<BaseCatalog2> getBaseCatalog2ByC1Id(Integer catalog1Id) {
        QueryWrapper<BaseCatalog2> queryWrapper = new QueryWrapper<BaseCatalog2>()
                .eq("catalog1_id", catalog1Id);
        return baseCatalog2Mapper.selectList(queryWrapper);
    }

    @Override
    public List<BaseCatalog3> getBaseCatalog3ByC2Id(Integer catalog2Id) {
        QueryWrapper<BaseCatalog3> wrapper = new QueryWrapper<BaseCatalog3>()
                .eq("catalog2_id", catalog2Id);
